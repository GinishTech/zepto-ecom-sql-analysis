# zepto-ecom-sql-analysis
An end-to-end data analysis project using MySQL to uncover retail, pricing, and inventory insights from a Zepto grocery dataset.
## SQL Analysis Insights

Below are the SQL queries used to perform the analysis on the Zepto dataset:
...
![Pareto Analysis SQL Logic](Query%2010.png)
...
![Pareto Analysis](Query%2010.png)
